      ...
      {activeTab === "messages" ? (
        ...
        <>
          ...
          <View style={styles.triageCard}>
            ...
            <Text style={styles.triageTitle}>Need a consultation?</Text>
            <Text style={styles.triageDesc}>
              Send a request to your assigned doctor for an urgent offline consultation.
            </Text>
            <TouchableOpacity
              style={[styles.primaryButton, isRequestingConsultation && styles.primaryButtonDisabled]}
