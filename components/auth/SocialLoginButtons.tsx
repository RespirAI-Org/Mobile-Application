...
export function SocialLoginButtons({ onGooglePress, onZaloPress }: SocialLoginButtonsProps) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.socialContainer}>
        <TouchableOpacity style={styles.socialButtonGoogle} onPress={onGooglePress}>
